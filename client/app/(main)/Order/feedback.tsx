...
const improveOption = ['Fast Service', 'Hotline Order', 'Seperated Ice Options'];

const Feedback: React.FC<FeedbackProps> = ({ navigation }) => {
    const [chosenLikeAboutOptions, setChosenLikeAboutOptions] = useState<Array<string>>([]);
    const [chosenImproveOptions, setChosenImproveOptions] = useState<Array<string>>([]);
    ...
    return (
        <View style={styles.contentContainer}>
            ...
            <View>
                <Text style={{ fontSize: 18, fontWeight: '700' }}>Your order is finised.</Text>
            ...
            <View>
                <Text style={{ fontSize: 14, fontWeight: '700' }}>What did you like about it?</Text>
            ...
            <View>
                <Text style={{ fontSize: 14, fontWeight: '700' }}>What could be improved?</Text>
                <View style={styles.optionContainer}>
