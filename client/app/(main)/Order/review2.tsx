...
const Review2: React.FC<ReviewProps> = ({ navigation }) => {
      ...
      <View style={styles.contentContainer}>
        <View style={styles.contentComponent}>
          ...
          >
            ...
            <TouchableOpacity onPress={() => {}}>
              <Text
                style={{ fontSize: 14, fontWeight: "700", color: "#967259" }}
              >
                Change
              </Text>
            </TouchableOpacity>
        ...
        <View style={styles.contentComponent}>
          ...
          <View style={[styles.cardStyle, { gap: 10 }]}>
            ...
            <View
              style={{ width: "100%", height: 1, backgroundColor: "#C5C6CC" }}
            />
            <View
              style={{ flexDirection: "row", justifyContent: "space-between" }}
            >
            ...
            >
              <Text
                style={{ color: "#1F2024", fontWeight: "700", fontSize: 16 }}
              >
                Total
              </Text>
              <Text style={styles.price}>$100.00</Text>
