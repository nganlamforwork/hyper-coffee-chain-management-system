...
const CreateOrderForm = ({
  ...
  }, [form, orderDetails, setOrderDetails]);
        ...
        <div className="flex gap-4">
          <Card className="w-full">
            <CardHeader>
              ...
              <CardDescription>Fill in customer information.</CardDescription>
            </CardHeader>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <div>
                    ...
                    <FormControl>
                      <Textarea rows={5} placeholder="Optional" {...field} />
                    </FormControl>
                    <FormMessage />
                  </div>
                )}
        ...
        <div className="mt-4">
          ...
          <div className="flex flex-col border rounded-lg p-4 gap-4">
            {orderDetails.length !== 0 ? (
              orderDetails.map((ordDetail: OrderDetails, index: number) => (
                <div
                  ...
                  <div className="flex gap-2">
                    ...
                    <div className="prose-sm">
                      ...
                      <ul className="list-disc">
                        {ordDetail.extras?.map((ext) => (
                          <li key={ext.id}>
                            {ext.name} - ${parseFloat(ext.price).toFixed(2)}
                          </li>
                        ))}
                      </ul>
                    </div>
